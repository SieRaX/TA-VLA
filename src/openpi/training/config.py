...
_CONFIGS = [
    ...
    #
    TrainConfig(
        name="pi0_fr3_button_push_effort_smoke",
        project_name="ta-vla-fr3",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
    ...
    TrainConfig(
        name="pi0_fr3_button_push_effort",
        project_name="ta-vla-fr3",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
        ...
        ema_decay=None,
        batch_size=8,
        # 62 epochs over fr3/button_push_tavla_train_100 (17,749 frames):
        # floor(17749 / 8) = 2218 steps/epoch * 62 = 137,516.
        num_train_steps=137_516,
        log_interval=1,
        save_interval=5_000,
        wandb_enabled=True,
    ),
    ...
    #
    TrainConfig(
        name="pi0_fr3_pnp_fixed_effort_smoke",
        project_name="ta-vla-fr3",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
    ...
    TrainConfig(
        ...
        ema_decay=None,
        batch_size=8,
        # 62 epochs over fr3/pnp_fixed_tavla_train_100 (22,051 frames):
        # floor(22051 / 8) = 2756 steps/epoch * 62 = 170,872.
        num_train_steps=170_872,
        log_interval=1,
        save_interval=5_000,
        wandb_enabled=True,
    ),
    ...
    #
    TrainConfig(
        name="pi0_fr3_peg_in_hole_effort_smoke",
        project_name="ta-vla-fr3",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
    ...
    TrainConfig(
        name="pi0_fr3_peg_in_hole_effort",
        project_name="ta-vla-fr3",
        model=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora",
            action_expert_variant="gemma_300m_lora",
