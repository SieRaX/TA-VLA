...
# "fr3/erase_whiteboard_tavla_train_100" is a symlink to the physical
# Erase_whiteboard/tavla/train_100 directory (HF repo_id allows only one slash).
...
SMOKE_NORM_STATS=assets/pi0_fr3_erase_whiteboard_effort_smoke/fr3/erase_whiteboard_tavla_train_100/norm_stats.json
...
REAL_NORM_STATS=assets/pi0_fr3_erase_whiteboard_effort/fr3/erase_whiteboard_tavla_train_100/norm_stats.json
